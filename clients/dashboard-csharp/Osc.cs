...
/// <summary>
/// Minimal OSC 1.0 codec - the same wire format as every other StageView client
/// (C++, Python, Dart, Object Pascal), so this dashboard talks to the same engine.
